...
# if request.method=='POST':
#         searchresult = request.form
#         searchresult = searchresult['searchproducts']
#         search_list = cur.execute("SELECT * FROM product where name='Apple'")
#         print("text"  + searchresult)
#         if(search_list>0):
#             product_list = cur.execute("SELECT * FROM product where name='Apple'")
#             if product_list>0:
#                 product_all = cur.fetchall()
#                 for prod in product_all:
#                     temp_dict = {}
